...
function forceOnTop(win) {
  ...
  applyAlwaysOnTopSetting(win, shouldBeOnTop);
...
/**
 * Apply alwaysOnTop setting with platform-specific configuration.
 */
...
/**
 * Apply invisibility mode (content protection) to a window
 */
...
/**
 * Update the window's AppUserModelId to group windows by app mode (Windows only)
 */
